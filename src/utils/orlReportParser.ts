...
import { OrlReport, zOrlReport } from '../schemas/orlReport';
 ...
 */
export function parseOrlReport(report: string | undefined): OrlReport | null {
  if (!report) {
  ...
  try {
    ...
    const loaded = yaml.load(cleanReport, {
    ...
    return zOrlReport.parse(loaded);
  } catch (error) {
