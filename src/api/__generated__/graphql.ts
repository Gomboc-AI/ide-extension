...
export type SecurityBenchmarksQuery = { __typename?: 'Query', securityBenchmarks: Array<{ __typename?: 'SecurityBenchmark', id: string, name: string, versions: Array<{ __typename?: 'SecurityBenchmarkVersion', id: string, name: string, recommendations: Array<{ __typename?: 'SecurityBenchmarkRecommendation', id: string, identifier: string, name: string, description?: string | null, isAdopted: boolean, controls: Array<{ __typename?: 'SecurityFrameworkControl', id: string, name: string, description: string }> }> }> }> };
